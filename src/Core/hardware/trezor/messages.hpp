...
enum MessageType {
	...
	MessageType_SpectreEmptyResponse                     = 800,
	MessageType_SpectreStartRequest                      = 801,
	MessageType_SpectreStartResponse                     = 802,
	MessageType_SpectreScanOutputsRequest                = 803,
	MessageType_SpectreScanOutputsResponse               = 804,
	MessageType_SpectreGenerateKeyimageRequest           = 805,
	MessageType_SpectreGenerateKeyimageResponse          = 806,
	MessageType_SpectreGenerateOutputSeedRequest         = 807,
	MessageType_SpectreGenerateOutputSeedResponse        = 808,
	MessageType_SpectreExportViewWalletRequest           = 809,
	MessageType_SpectreExportViewWalletResponse          = 810,
	MessageType_SpectreSignStartRequest                  = 811,
	MessageType_SpectreSignAddInputRequest               = 813,
	MessageType_SpectreSignAddOutputRequest              = 815,
	MessageType_SpectreSignAddOutputResponse             = 816,
	MessageType_SpectreSignAddExtraRequest               = 817,
	MessageType_SpectreSignStepARequest                  = 819,
	MessageType_SpectreSignStepAResponse                 = 820,
	MessageType_SpectreSignStepAMoreDataRequest          = 821,
	MessageType_SpectreSignGetC0Request                  = 823,
	MessageType_SpectreSignGetC0Response                 = 824,
	MessageType_SpectreSignStepBRequest                  = 825,
	MessageType_SpectreSignStepBResponse                 = 826,
	MessageType_SpectreStartProofRequest                 = 827
};
